...
class Ui_update_reception(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "Изменение записи"))
        self.label_2.setText(_translate("Dialog", "Лечение"))
        self.label_3.setText(_translate("Dialog", "Болезнь"))
        self.label_5.setText(_translate("Dialog", "Пациента"))
        self.add_reception_window.setText(_translate("Dialog", "Доктор"))
